...
class TenantProvisioningService
{
    ...
    private function seedTenantBaseline(string $tenantId): void
    {
        ...
        // Default "Store" consignor is created by migration 020_seed_store_consignor.sql
        // so it exists whether the tenant was provisioned or created via migrate-tenant-by-slug.
